 ...
 * @returns 
 */
const insertRiesgo = (data, isUpdate) => {
 ...
 * @returns 
 */
const insertSiniestro = async (data, num_tramite, isUpdate) => {
 ...
 * @returns 
 */
const insertArchivo = async (data, num_tramite, isUpdate) => {
    
    let numArchivo = null

    if (isUpdate) {
        numArchivo = data.codSiniestro
    } else {
        numArchivo = uuidv4()
    }
 ...
 * @returns 
 */
const insertEnlace = async (data, num_tramite, isUpdate) => {
    let numEnlace = null
...
const getSiniestro = (num_tramite) => {
    let params = {
        TableName: TABLE_SINIESTRO,
        KeyConditionExpression: "#num_tramite = :num_tramite",
        ExpressionAttributeNames:{
